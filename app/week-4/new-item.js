...
export default function NewItem({currentQuantity,incrementFunction,decrementFunction}){
    ...
    return(
        <div className="flex justify-center w-full">
            <div className="p-2 m-4 bg-black text-white w-36">
                <div className="flex justify-between">
                    <p>{currentQuantity}</p>
                    <div className="flex">        
                        <button className={buttonStyles2} onClick={incrementFunction}>+</button>
                        <button className={buttonStyles1} onClick={decrementFunction}>-</button>
                    </div>
                </div>
            </div>
        </div>
